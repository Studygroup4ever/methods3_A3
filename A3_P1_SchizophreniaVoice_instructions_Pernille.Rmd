...
Pitch <- 
    for n in length(list)

read.delim("Articulation.txt", header = TRUE, sep = ",")

testPitch <-  read.delim("Pitch/Study5D1S26T2.txt", sep = "\t", header = T)

f <- str_extract("Study5D1S26T2.txt", 'T(\\dT\\d|\\d)')
...
read_pitch <- function(filename) {
    ...
    data <- c(f_name, Study, Diagnosis, Subject)
     return(data)
}
# try lapply??
```
